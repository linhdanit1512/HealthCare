...
public class Doctor implements java.io.Serializable {
	...
	private Set<Schedules> scheduleses = new HashSet<>(0);
	...
	public String toString() {
		return "Doctor " + idDoctor + ": clinic: " + clinic + ", specialty=" + specialty + ", username="
				+ username + ", nameDoctor=" + nameDoctor + ", passwords=" + passwords + ", phone=" + phone
				+ ", passport=" + passport + ", degree=" + degree + ", experience=" + experience + ", address="
				+ address + ", wordspace=" + wordspace + ", timeCreate=" + timeCreate + ", isCheck=" + isCheck
				+ ", scheduleses=" + scheduleses + ", reservations=" + reservations + ", messages=" + messages + "]";
	}
