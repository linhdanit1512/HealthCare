...
public class DoctorUtil {
	...
	public DoctorUtil() {
		Doctor doctor = new Doctor(1, null, null, "A", "Nguyễn Văn A", "123", "0123456789","ABC@gmail.com", "passport1",
				"Bác sĩ cao cấp", 22, "Hồ Chí Minh", new Date(), true, null, null, null);
		Doctor doctor2 = new Doctor(2, null, null, "B", "Nguyễn Văn B", "123", "0123456788","XYZ@gmail.com", "passport2",
